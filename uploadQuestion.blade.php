...
<div class="container-xxl bg-white p-0">
                ...
                <nav
                    ...
                    <div
                        ...
                        <ul class="navbar-nav mr-auto py-0">
                            ...
                            <li class="nav-item"><a
                                    href="{{ route('upload-answer-page') }}"
                                    class="nav-link">Answers</a></li>
                            <li class="nav-item"><a
                                    href="{{ route('upload-school-page') }}"
    ...
    <main>
        <div class="card w-96 bg-base-100 shadow-xl">
            <div class="card-body">
                <p>Upload Question Excel Sheet</p>
                <div class="card-actions justify-end">
                    <form action="{{ route('upload-file') }}" method="POST"
                        ...
                        @csrf
                        <input type="file"
                               class="file-input file-input-bordered w-full max-w-xs @error('file') ring-red-500 @enderror"
                               value="{{ old('file') }}"
                               name="file" id="file"/>
                        <br>
                        @error('file')
                        ...
                        @enderror
                        <button type="submit"
                                style="background-color: orange; color: white; margin-right: 200px; padding: 20px; font-size: 20px; border-radius: 25px; margin-top: 10px;">
                            Upload
                        </button>
                    </form>
                </div>
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function () {
        const sessionMessage = document.getElementsById('alert');
        if (sessionMessage) {
            setTimeout(() => {
