...
<header>
                ...
                <nav
                    ...
                    <div
                        ...
                        <div class="navbar-nav mr-auto py-0">
                            ...
                            <a style="color:orange; margin-left: 20px"
                               href={{route ('dashboard')}} class="nav-item
                               nav-link">Statistics</a>
                            </div>
                        </div>
                    </div>
                    <div class="image">
    ...
    <aside id="sidebar" class="sidebar mt-14">
        ...
        <ul class="sidebar-nav" id="sidebar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" data-bs-target="\dashboard"
                   data-bs-toggle="collapse"
                   href="\dashboard">
                    <i class="bi bi-bar-chart"></i><span>Rankings</span><i
                        class="bi bi-chevron-down ms-auto"></i>
                </a>
        ...
        <section class="section">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card-title">List of best performing
                                schools for all challenges </h5>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <h5 class="card-title">List of worst
                                        performing schools for all
                                        challenges </h5>
                                    <table class="table datatable">
                                        <thead>
                                        <tr>
