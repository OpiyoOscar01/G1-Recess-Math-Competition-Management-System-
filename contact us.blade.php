        ...
        <div class="container">
            ...
            <div class="row g-4">
                <div class="col-12">
                    <div class="row gy-4">
                        <div class="col-md-4">
                            <h6 class="section-title text-start text-primary text-uppercase">Registration</h6>
                            <p><i class="fa fa-envelope-open text-primary me-2"></i>register@example.com</p>
                        </div>
                        <div class="col-md-4">
                            <h6 class="section-title text-start text-primary text-uppercase">General</h6>
                            <p><i class="fa fa-envelope-open text-primary me-2"></i>math@example.com</p>
                        </div>
                        <div class="col-md-4">
            ...
            <div class="row g-5">
                <div class="col-md-6 col-lg-4">
                    <div class="bg-primary rounded p-4">
                        <a href="index.html">
                            <h1 class="text-white text-uppercase mb-3"><span class="text-green-600">M</span><span
                                    class="text-sky-700">C</span><span class="text-green-600">M</span><span
                                    class="text-sky-700">S</span></h1>
                        </a>
                ...
                <div class="col-md-6 col-lg-3">
                    ...
                    <p class="mb-2"><i class="fa fa-map-marker-alt me-3"></i>Makerere University, Kampala, Uganda</p>
